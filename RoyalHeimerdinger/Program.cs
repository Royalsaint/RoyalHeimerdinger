...
namespace Royal_Heimer
{
    ...
    internal class program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Menu
            Config = new Menu(Champion, "RoyalHeimerdinger", true);

            //Ts
            var targetSelectorMenu = new Menu("Target Selector", "Seletor de Alvo");
            ...
            //Combo Menu
            Config.AddSubMenu(new Menu("Combo do Capiroto", "Combo"));
            Config.SubMenu("Combo").AddItem(new MenuItem("UseWCombo", "Usar W")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("UseECombo", "Usar E")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRCombo", "Usar R")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("UseItems", "Usar Items")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("ActiveCombo", "Combo!").SetValue(new KeyBind(32, KeyBindType.Press)));
            Config.SubMenu("Combo").AddItem(new MenuItem("posPrint", "Print Posicao!").SetValue(new KeyBind(32, KeyBindType.Press)));


            //KS Menu
            Config.AddSubMenu(new Menu("KS Hu3BR", "KSMenu"));
            Config.SubMenu("KSMenu").AddItem(new MenuItem("rwKS", "Usar R->W para KS")).SetValue(true);
            Config.SubMenu("KSMenu").AddItem(new MenuItem("KSW", "Usar W")).SetValue(true);
            Config.SubMenu("KSMenu").AddItem(new MenuItem("KSE", "Usar E")).SetValue(true);

            //Safe Menu
            Config.AddSubMenu(new Menu("Proteja-me", "SafeMenu"));
            Config.SubMenu("SafeMenu").AddItem(new MenuItem("ZhoUlt", "Torre Ult Zhonya")).SetValue(true);

            //Turret spot drawings
            Config.AddSubMenu(new Menu("Configurar Torres", "drawTur"));
            Config.SubMenu("drawTur").AddItem(new MenuItem("DrawSpots", "Local das torres")).SetValue(true);
            Config.SubMenu("drawTur").AddItem(new MenuItem("TurOnSpot", "Botar torre no spot")).SetValue(new KeyBind(32, KeyBindType.Press));

            //Range Drawings
            Config.AddSubMenu(new Menu("Desenhos Lindos", "Drawings"));
            Config.SubMenu("Drawings").AddItem(new MenuItem("DrawEnable", "Ativar Desenhos"));

            Config.SubMenu("Drawings").AddItem(new MenuItem("DrawQ", "Desenhar Q")).SetValue(true);
            Config.SubMenu("Drawings").AddItem(new MenuItem("DrawW", "Desenhar W")).SetValue(true);
            Config.SubMenu("Drawings").AddItem(new MenuItem("DrawE", "Desenhar E")).SetValue(true);
            Config.SubMenu("Drawings").AddItem(new MenuItem("CircleLag", "Lag Free Circles").SetValue(true));
            Config.SubMenu("Drawings").AddItem(new MenuItem("CircleQuality", "Qualidade Circulo").SetValue(new Slider(100, 100, 10)));
            Config.SubMenu("Drawings").AddItem(new MenuItem("CircleThickness", "Espessura Circulo").SetValue(new Slider(1, 10, 1)));
